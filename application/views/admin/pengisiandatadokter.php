<?php echo form_open('proses/proses_pengisian_data_dokter'); ?>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="texte" class="form-control" id="email" name="nama_dokter" placeholder="Isi nama dokter">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="email" name="spesialis" placeholder="Isi spesialis">
		</div>
	</div>
